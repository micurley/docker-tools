...
c.NotebookApp.config_file = '/root/.jupyter/jupyter_notebook_config.py'
...
#  Choices: any of ['sha224', 'sha384', 'blake2b', 'sha512', 'sha3_224', 'sha3_256', 'sha3_384', 'sha256', 'sha1', 'md5', 'blake2s', 'sha3_512']
#  Default: 'sha256'
